...
namespace H3D {
  ...
  public:
    ...
    /// Finds all the nodes of a given type (and optional name) by searching downwards from this node
    ...
    /// AutoRefVector<Material> materials;
    /// Node::SearchFieldNameMap seach_fields;
    /// seach_fields["Scene"].push_back ( "sceneRoot" );
    /// seach_fields["Group"].push_back ( "children" );
    /// seach_fields["Anchor"].push_back ( "children" );
    /// seach_fields["Shape"].push_back ( "appearance" );
    /// seach_fields["Appearance"].push_back ( "material" );
    /// scene->findNodes ( materials, "", NULL, &seach_fields );
    /// \endcode
    ///
    ...
    void findNodes ( 
      ...
      if ( NodeType* n= dynamic_cast < NodeType* > ( this ) ) {
      ...
      if ( _searchFieldNames ) {
        SearchFieldNameMap::iterator i= _searchFieldNames->find ( this->getTypeName() );
          ...
          if ( f->getAccessType() != Field::INPUT_ONLY ) {
            ...
            if ( SFNode* sf_node= dynamic_cast< SFNode * >( f ) ) {
              ...
              if ( c ) {
                ...
                c->findNodes ( _result, _nodeName, _parentMap, _searchFieldNames, _verbose, this );
              }
