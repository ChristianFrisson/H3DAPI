...
//
//
/// \file MetadataDouble.h
/// \brief Header file for MetadataDouble, X3D scene-graph node
///
//
//////////////////////////////////////////////////////////////////////////////
#ifndef __METADATADOUBLE_H__
#define __METADATADOUBLE_H__
...
namespace H3D {
  ...
  class H3DAPI_API MetadataDouble: 
    public X3DNode,
  ...
  public:
    ...
    /// Constructor.
    MetadataDouble( Inst< SFString       > _name      = 0,
                    Inst< SFString       > _reference = 0,
                    Inst< SFMetadataNode > _metadata  = 0,
                    Inst< MFDouble       > _value     = 0);
