...
//
//
/// \file ShaderImage3D.h
/// \brief Header file for ShaderImage3D.
///
//
//////////////////////////////////////////////////////////////////////////////
#ifndef __SHADERIMAGE3D_H__
#define __SHADERIMAGE3D_H__
...
namespace H3D {
  ...
  /// \ingroup H3DNodes
  /// \class ShaderImage3D
  /// \brief ShaderImage2D is a 3D image which can allow openGL to read from  
  ...
  ///
  /// \par Internal routes:
  /// \dotfile ShaderImage3D.dot
  /// 
  class H3DAPI_API ShaderImage3D : 
    public ShaderImageNode {
  public:
  
    /// Constructor.
    ShaderImage3D( Inst< DisplayList  > _displayList = 0,
    ...
    /// the depth of this 3D texture image
    /// <b>Access type:</b> inputOutput \n
    /// <b>Default value:</b> 8 \n
    ...
    /// <b>Valid values:</b> "GL_RGBA16F", "GL_RGBA32F"
