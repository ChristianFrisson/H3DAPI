...
//
//
/// \file H3DGeneratedFragmentShaderNode.cpp
/// \brief CPP file for H3DGeneratedFragmentShaderNode.
///
//
//
//////////////////////////////////////////////////////////////////////////////
...
H3DNodeDatabase H3DGeneratedFragmentShaderNode::database( 
                                   "H3DGeneratedFragmentShaderNode", 
                                   NULL,
                                   typeid( H3DGeneratedFragmentShaderNode ),
                                   &H3DGeneratedShaderNode::database );

namespace H3DGeneratedFragmentShaderNodeInternals {
}

H3DGeneratedFragmentShaderNode::H3DGeneratedFragmentShaderNode( 
  ...
  type_name = "H3DGeneratedFragmentShaderNode";
