...
namespace H3D {
  ...
  /// artifacts.
  ///
  class H3DAPI_API HapticForceEffect: public HapticObject, 
                                      public RefCountedClass {
  public:
    /// The input to a HapticForceEffect. 
    struct H3DAPI_API EffectInput {
      /// Constructor.
      EffectInput( const Vec3f &pos = Vec3f( 0,0,0 ),
    ...
    struct H3DAPI_API EffectOutput {
      /// Constructor.
      EffectOutput( const Vec3f _force = Vec3f( 0,0,0 ),
                    const Vec3f _torque = Vec3f( 0,0,0 ) ) :
        force( _force ),
        torque( _torque ) {}
