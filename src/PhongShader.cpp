...
"// i is the index of the light\n"
"vec4 pointLightPhong(in gl_LightSourceParameters light, \n"
"                     in vec3 normal, \n"
"                     in vec3 vertex, \n"
"                     in float material_shininess,\n"
"                     in vec4 material_ambient, \n"
...
"// Returns the color generated by one point light using the Phong lighting model.\n"
"// i is the index of the light\n"
"vec4 pointLightPhongX3D(in gl_LightSourceParameters light, \n"
"                        in vec3 normal, \n"
"                        in vec3 vertex, \n"
"                        in float material_shininess,\n"
"                        in vec4 material_ambient, \n"
...
"// i is the index of the light\n"
"vec4 spotLightPhong( in gl_LightSourceParameters light, \n"
"                     in vec3 normal, \n"
"                     in vec3 vertex, \n"
"                     in float material_shininess,\n"
"                     in vec4 material_ambient, \n"
...
"// Returns the color generated by one spot light using the Phong lighting model.\n"
"// i is the index of the light\n"
"vec4 spotLightPhongX3D( in gl_LightSourceParameters light,\n"
"                        in vec3 normal, \n"
"                        in vec3 vertex, \n"
"                        in float material_shininess,\n"
"                        in vec4 material_ambient, \n"
...
"// i is the index of the light\n"
"vec4 lightPhong(in gl_LightSourceParameters light, \n"
"                in vec3 normal, \n"
"                in vec3 vertex, \n"
"                in float shininess,\n"
"                in vec4 ambient, \n"
...
"  else\n"
"    return spotLightPhong(light, normal, vertex, shininess, ambient, diffuse, specular);\n"
  "}\n";
...
string PhongShader::getLightContribution( X3DLightNode *light,
  ...
  if( !light || dir_light) {
    ...
    // point light
    if( point_light ) {
      s << "      final_color += pointLightPhongX3D( light, " << normal << ", " << vertex << ", " << shininess << ", " <<  ambient_color << ", " << diffuse_color << ", " << specular_color << ", " << uniqueLightFieldName( "radius", point_light ) << ");" << endl;
    } else {
      // spot light
      if( spot_light ) {
        s << "      final_color += spotLightPhongX3D( light, " << normal << ", " << vertex << ", " << shininess << ", " <<  ambient_color << ", " << diffuse_color << ", " << specular_color << ", " << uniqueLightFieldName( "radius", spot_light ) <<", " << uniqueLightFieldName( "beamWidth", spot_light ) << ");" << endl;
      } else {
        // default
        s << "      final_color += lightPhong( light, " << normal << ", " << vertex << ", " << shininess << ", " <<  ambient_color << ", " << diffuse_color << ", " << specular_color << ");" << endl;
      }
    }
  }
