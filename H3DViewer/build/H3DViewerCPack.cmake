  ...
  IF( WIN32 )
    ...
    IF( NOT DEFINED H3DViewer_CPACK_EXTERNAL_ROOT )
      ...
      IF( H3D_USE_DEPENDENCIES_ONLY )
        SET( H3DViewer_CPACK_EXTERNAL_ROOT_DEFAULT "${EXTERNAL_INCLUDE_DIR}/.." )
...
#               DESTINATION lib )
  ...
  IF( WIN32 )
    ...
    IF( CMAKE_SIZEOF_VOID_P EQUAL 8 ) # check if the system is 64 bit
      ...
      SET( CPACK_NSIS_DISPLAY_NAME_POSTFIX " (x64)" )
    ...
    SET( CPACK_NSIS_CREATE_ICONS "  CreateShortCut \\\"$SMPROGRAMS\\\\$STARTMENU_FOLDER\\\\H3DViewer${CPACK_NSIS_DISPLAY_NAME_POSTFIX}.lnk\\\" \\\"$INSTDIR\\\\H3DViewer\\\\bin\\\\H3DViewer.exe\\\"" )
    SET( CPACK_NSIS_DELETE_ICONS_EXTRA "  Delete \\\"$SMPROGRAMS\\\\$MUI_TEMP\\\\H3DViewer${CPACK_NSIS_DISPLAY_NAME_POSTFIX}.lnk\\\"" )
