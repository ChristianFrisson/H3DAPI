...
FIND_PATH( 3DXWARE_INCLUDE_DIRS NAMES si.h siapp.h H3D/xdrvlib.h X11/Xlib.h X11/Xutil.h X11/Xos.h X11/Xatom.h X11/keysym.h
           PATHS  /usr/local/include 
                 $ENV{H3D_EXTERNAL_ROOT}/include  
                 $ENV{H3D_EXTERNAL_ROOT}/include/3dconnexion/inc
                 ../../External/include    
                 ../../External/include/3dconnexion/inc )
MARK_AS_ADVANCED(3DXWARE_INCLUDE_DIRS)
...
IF(3DXWARE_INCLUDE_DIRS AND 3DXWARESIAPP_LIBRARY AND 3DXWARESPWMATH)
  SET(3DXWARE_FOUND 1)
  SET(3DXWARE_LIBRARIES ${3DXWARESIAPP_LIBRARY} ${3DXWARESPWMATH_LIBRARY})
  SET(3DXWARE_INCLUDE_DIR ${3DXWARE_INCLUDE_DIRS})
ELSE(3DXWARE_INCLUDE_DIRS AND 3DXWARESIAPP_LIBRARY AND 3DXWARESPWMATH)
  SET(3DXWARE_FOUND 0)
  SET(3DXWARE_LIBRARIES)
  SET(3DXWARE_INCLUDE_DIR)
ENDIF(3DXWARE_INCLUDE_DIRS AND 3DXWARESIAPP_LIBRARY AND 3DXWARESPWMATH)

# Report the results.
IF(NOT 3DXWARE_FOUND)
  SET(3DXWARE_DIR_MESSAGE
    "3dxware (ww.3dconnexion) was not found. Make sure 3DXWARE_LIBRARY and 3DXWARE_INCLUDE_DIRS are set.")
  IF(NOT 3DXWARE_FIND_QUIETLY)
    MESSAGE(STATUS "${3DXWARE_DIR_MESSAGE}")
  ELSE(NOT 3DXWARE_FIND_QUIETLY)
    IF(3DXWARE_FIND_REQUIRED)
      MESSAGE(FATAL_ERROR "${3DXWARE_DIR_MESSAGE}")
    ENDIF(3DXWARE_FIND_REQUIRED)
  ENDIF(NOT 3DXWARE_FIND_QUIETLY)
