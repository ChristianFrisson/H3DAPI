...
FIND_PATH( DIRECTSHOW_INCLUDE_DIRS_STREAMS_H NAMES streams.h
           PATHS $ENV{H3D_EXTERNAL_ROOT}/include  
                 $ENV{H3D_EXTERNAL_ROOT}/include/DirectShow/BaseClasses
                 ../../External/include    
                 ../../External/include/DirectShow/BaseClasses )
MARK_AS_ADVANCED(DIRECTSHOW_INCLUDE_DIRS_STREAMS_H)

FIND_PATH( DIRECTSHOW_INCLUDE_DIRS_DDRAW_H NAMES ddraw.h
           PATHS $ENV{DXSDK_DIR}/include
                 ${DIRECTSHOW_EXTRA_DIR} )
MARK_AS_ADVANCED(DIRECTSHOW_INCLUDE_DIRS_DDRAW_H)
...
IF(DIRECTSHOW_INCLUDE_DIRS_STREAMS_H AND DIRECTSHOW_INCLUDE_DIRS_DDRAW_H AND DIRECTSHOW_LIBRARY)
  SET(DIRECTSHOW_FOUND 1)
  SET(DIRECTSHOW_LIBRARIES ${DIRECTSHOW_LIBRARY})
  SET(DIRECTSHOW_INCLUDE_DIR ${DIRECTSHOW_INCLUDE_DIRS_STREAMS_H} ${DIRECTSHOW_INCLUDE_DIRS_DDRAW_H})
ELSE(DIRECTSHOW_INCLUDE_DIRS_STREAMS_H AND DIRECTSHOW_INCLUDE_DIRS_DDRAW_H AND DIRECTSHOW_LIBRARY)
  SET(DIRECTSHOW_FOUND 0)
  SET(DIRECTSHOW_LIBRARIES)
  SET(DIRECTSHOW_INCLUDE_DIR)
ENDIF(DIRECTSHOW_INCLUDE_DIRS_STREAMS_H AND DIRECTSHOW_INCLUDE_DIRS_DDRAW_H AND DIRECTSHOW_LIBRARY)
