...
stereo_mode_box_options = ["No stereo", "Quad buffered", "Horizontal split", "Vertical split", "Horizontal interlaced", "Vertical interlaced", "Sharp display", "Red-Blue stereo", "Red-Cyan stereo" ]

stereo_mode_strings = [ "MONO", "QUAD_BUFFERED_STEREO", "HORIZONTAL_SPLIT", "VERTICAL_SPLIT", "HORIZONTAL_INTERLACED", "VERTICAL_INTERLACED", "VERTICAL_INTERLACED_GREEN_SHIFT", "RED_BLUE_STEREO", "RED_CYAN_STEREO" ]
